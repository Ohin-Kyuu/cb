...
if [[ $1 == "--blue" ]]; then
    ...
    run_script_with_delay "/home/startup/task/cb-cam-blue.sh" 20
    run_script_with_delay "/home/startup/task/cb-tf-blue.sh" 5
elif [[ $1 == "--yellow" ]]; then
     echo -e "Choosing \e[1mYELLOW\e[0m team ..."
    run_script_with_delay "/home/startup/task/cb-cam-yellow.sh" 20
    run_script_with_delay "/home/startup/task/cb-tf-yellow.sh" 5
fi
