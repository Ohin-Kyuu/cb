...
class Node:
    def __init__(self):
        ...
        self.col1_msg = None
        self.dep1_msg = None
        self.sub_col1 = rospy.Subscriber("/cb/color/image_raw", Image, self.col_callback1)
        self.sub_dep1 = rospy.Subscriber("/cb/aligned_depth_to_color/image_raw", Image, self.dep_callback1) 
        ...
        ###### YOLO STARTS HERE ######
        self.yolo_thread = Thread(target=self.yolo)
